/*
    [] Add verification for form inputs
...
const howToUseButton = document.querySelector("#howToUseHeader");
...
howToUseButton.addEventListener("click", () => {
    ...
    if(howToUseContainer.style.display === "none"){
...
addBookForm.addEventListener( "submit", function(e){
    ...
    const uniqueId = `${new Date().getTime()}-${bookTitle.split(' ').join('')}`;

    const newBook = new Book(uniqueId, bookTitle, bookAuthor, bookPages, readStatus === "read" ? true : false);
